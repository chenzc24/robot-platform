...
3. With ESP32 `tcp_v2_l2`, prove wrong-credential rejection, correct `HELLO/PING/STATUS`, `motion_permitted=false`, lease expiry, and reconnect. No CAN object or motor may be created.
