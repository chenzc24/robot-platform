"""Composition entry point for safe idle or the RCP/TCP v3 L2/L3 listener."""
...
def main():
    ...
    if runtime_mode not in ("tcp_v3_l2", "tcp_v3_l3"):
        return SAFE_IDLE
    ...
    service_factory = (
        make_l2_service if runtime_mode == "tcp_v3_l2" else make_l3_service_factory()
    )
